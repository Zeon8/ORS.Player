...
public sealed partial class VideoPlayer : DisposableBase
{
    ...
    private void LoadVideo(Video? video)
    {
        ...
        if (video != null)
        {
            ...
            _textureBuffer = new RenderTarget2D(_graphicsDevice, video.Width, video.Height, false, SurfaceFormat.Color, DepthFormat.None, 0, RenderTargetUsage.PreserveContents);
        }
    }
    ...
    private static GraphicsDevice GetCurrentGraphicsDevice()
    {
        ...
        {
            throw new NullReferenceException("Game graphics device is null.");
        }
